...
namespace org.newpointe.Connections.Workflow
{
    /// <summary>
    ...
    [ExportMetadata("ComponentName", "Create Connection Request w/ Comment")]
    ...
    public class CreateConnectionRequest2 : ActionComponent
    {
        /// <summary>
