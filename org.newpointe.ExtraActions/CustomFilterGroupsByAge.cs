...
namespace org.newpointe.ExtraActions
{
    ...
    [ExportMetadata( "ComponentName", "Custom Filter Groups By Age" )]
    ...
    public class CustomFilterGroupsByAge : CheckInActionComponent
    {
        /// <summary>
                ...
                foreach ( var person in family.People )
                {
                    ...
                    foreach ( var groupType in person.GroupTypes.ToList() )
                    {
                        foreach ( var group in groupType.Groups.ToList() )
                        {
                            ...
                            bool? groupAgeRequired = group.Group.GetAttributeValue( "AgeRequired" ).AsBooleanOrNull();
