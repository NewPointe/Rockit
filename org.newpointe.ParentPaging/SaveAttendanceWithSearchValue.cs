...
namespace Rock.Workflow.Action.CheckIn
{
    ...
    [Description( "Saves the selected check-in data as attendance w/ the search query" )]
    [Export( typeof( ActionComponent ) )]
    [ExportMetadata( "ComponentName", "Save Attendance w/ Search" )]
    public class SaveAttendanceWithSearchValue : CheckInActionComponent
    {
        /// <summary>
