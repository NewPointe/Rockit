...
namespace RockWeb.Plugins.org_newpointe.CustomLoginStatus
{
    /// <summary>
    ...
    public partial class CustomLoginStatus : Rock.Web.UI.RockBlock
    {
        ...
        protected override void OnLoad( EventArgs e )
        {
            ...
            if ( currentPerson != null )
            {
                ...
                var givingURL = LinkedPageUrl("GiveNowPage", null);
                if (!string.IsNullOrWhiteSpace(givingURL))
                {
                    hlGiveNow.NavigateUrl = givingURL;
                }
                else
                {
                    phGiveNow.Visible = false;
                }
