<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CustomLoginStatus.ascx.cs" Inherits="RockWeb.Plugins.org_newpointe.CustomLoginStatus.CustomLoginStatus" %>
...
<ul class="nav navbar-nav loginstatus">    
    <li class="dropdown" ID="liDropdown" runat="server">
        ...
        <ul class="dropdown-menu">
            ...
            <asp:PlaceHolder ID="phGiveNow" runat="server">
                <li>
                    <asp:HyperLink ID="hlGiveNow" runat="server" Text="Give Now" />
                </li>
            </asp:PlaceHolder>
            <li class="divider"></li>
