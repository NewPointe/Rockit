...
namespace RockWeb.Plugins.org_newpointe.WorkflowReport
{
    ...
    [Category("Newpointe.org Workflow")]
    ...
    public partial class WorkflowReport : Rock.Web.UI.RockBlock
    {
        ...
        protected void doStuff()
        {
            ...
            filteredWorkflowData = filteredWorkflowData.ToList().AsQueryable().Where(ws => ws.CreatedDateTime > dateRange.LowerValue && ws.CreatedDateTime < dateRange.UpperValue);
