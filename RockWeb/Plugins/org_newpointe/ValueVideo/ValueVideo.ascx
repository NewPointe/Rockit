...
<div class="value-video container-fluid">
    ...
    <div class="row">
            ...
            <video controls="" poster="/Content/central/Video_image_placeholder_for_the_website.png">
                <source onclick="this.paused?this.play():this.pause();" 
                    src="/Content/central/newpointe_..._this_is_who_we_are_..._this_is_what_we_value_1280x720.mp4?_=1" type="video/mp4" />
