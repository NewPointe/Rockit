...
namespace RockWeb.Plugins.org_newpointe.BetterPersonSearch
{
    [DisplayName( "Better Person Search" )]
    [Category( "NewPointe -> CRM" )]
    ...
    public partial class BetterPersonSearch : Rock.Web.UI.RockBlock
    {
        #region Fields
