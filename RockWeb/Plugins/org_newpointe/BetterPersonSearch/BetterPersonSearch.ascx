<%@ Control Language="C#" AutoEventWireup="true" CodeFile="BetterPersonSearch.ascx.cs" Inherits="RockWeb.Plugins.org_newpointe.BetterPersonSearch.BetterPersonSearch" %>
