...
namespace RockWeb.Plugins.org_newpointe.SampleProject
{
    /// <summary>
    /// Displays the details of a Referral Agency.
    /// </summary>
    [DisplayName( "Referral Agency Detail" )]
    [Category( "org_newpointe > Sample Project" )]
    ...
    public partial class ReferralAgencyDetail : Rock.Web.UI.RockBlock
    {
        ...
        protected override void OnInit( EventArgs e )
        {
            ...
            var definedType = DefinedTypeCache.Read( org.newpointe.SampleProject.SystemGuid.DefinedType.REFERRAL_AGENCY_TYPE.AsGuid() );
            if (definedType != null)
            {
