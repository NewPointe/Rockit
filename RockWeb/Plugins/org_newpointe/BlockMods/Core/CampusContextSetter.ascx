<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CampusContextSetter.ascx.cs" Inherits="RockWeb.Plugins.org_newpointe.BlockMods.Core.CampusContextSetter" %>
