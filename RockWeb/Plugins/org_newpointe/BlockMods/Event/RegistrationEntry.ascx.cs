...
namespace RockWeb.Plugins.org_newpointe.BlockMods.Event
{
    /// <summary>
    /// Block used to register for a registration instance.
    /// </summary>
    [DisplayName( "Custom Registration Entry" )]
                ...
                case RegistrationPersonFieldType.Campus:
                    {
                        ...
                        cpHomeCampus.Campuses = CampusCache.All().Where(c => !c.Name.Contains("Central Services") && !c.Name.Contains("Online") && !c.Name.Contains("Future") && (c.IsActive ?? false)).ToList();
