<%@ Control Language="C#" AutoEventWireup="true" CodeFile="TreeViewTest.ascx.cs" Inherits="RockWeb.Plugins.org_newpointe.Checkin.TreeViewTest" %>
                ...
                <script type="text/javascript">
                    ...
                    $(function () {
                        ...
                        for (i = 0; i < ev.length; ++i) {
                            _findNodeById(ev[i], rt.nodes).isOpen = true;
                        }
                        rt.render();
                    });
