...
namespace RockWeb.Plugins.org_newpointe.Checkin
{
    ...
    public partial class CheckinGroupList : Rock.Web.UI.RockBlock
    {
        ...
        StringBuilder _content2 = new StringBuilder();
        ...
        private void ShowContent()
        {
            ...
            hfSelectedItemId.Value = Request["GroupTypeId"];
            hfInitialCategoryParentIds.Value = Server.UrlDecode(Request["ExpandedIds"]);
            ...
            {
                if (!string.IsNullOrWhiteSpace(GetAttributeValue("GroupTypeTemplate")))
                {
                    configurationTemplateGuid = new Guid(GetAttributeValue("GroupTypeTemplate"));
                }
            }
