...
namespace org.newpointe.CompositeScoresJob
{
    /// <summary>
    ...
    public class CompositeScoresJob : IJob
    {
        ...
        public virtual void Execute(IJobExecutionContext context)
        {
            ...
            FiscalYearStartDate = dataMap.GetString("FiscalYearStartDate");



            var campus = CampusCache.All().Where(a => a.IsActive == true);

            foreach (var x in campus)
            {
                CalulateMetrics(x.Id);
            }
